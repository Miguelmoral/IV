...
def command_start(m):
    ...
    cadena = "Posibles comandos para el bot:" + "\n" + "/carreras muestra un listado de las posibles carreras" + "\n" + "/resultados año codigo_carrera sesión muestra los resultados de esa carrera (ej: /resultados 2015 ARA Q2)"
